...
namespace Ders52Minİstanbul_1
{
    partial class FrmMetro
    {
        ...
        private void InitializeComponent()
        {
            ...
            "M1B metro hattı (Kirazlı - Bağcılar‎→Yenikapı)",
            "M2 metro hattı (Hacıosman‎→Yenikapı)",
            "M3 metro hattı (Başakşehir - Metrokent‎→Kirazlı - Bağcılar)",
            "M4 metro hattı (Kadıköy‎→Tavşantepe)",
            "TF1 metro hattı (Maçka‎→Taşkışla)",
            "TF2 metro hattı (Eyüp‎→Pierre Loti)"});
            ...
            this.button1.Location = new System.Drawing.Point(499, 173);
